...
export async function GET() {
    try {
        ...
        const records = await base(TABLE_CERTIFICATIONS).select({
            fields: [
                "Certification Title", "Description", "Certification Level", "Program Duration", "Number of Projects", "Learn More URL"
            ]
        }).all();
