      ...
      <div className="bg-gradient-to-r  text-white pt-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          <div className="flex flex-col items-center justify-between gap-2">
            <h1 className="text-4xl md:text-4xl font-bold mb-6 text-balance">Articles & Insights</h1>
            <div>

              <p className="text-xl text-blue-100 max-w-4xl leading-relaxed text-center">
            ...
            <button
              ...
              disabled={apiLoading}
              className="bg-[#1a729c] backdrop-blur-sm border border-white/20 text-white px-5 py-2 rounded-xl font-medium hover:bg-[#010817]/80 transition-all duration-300 flex items-center gap-3 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
