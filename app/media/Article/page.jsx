        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          <div className="flex flex-col items-center justify-between gap-4">
            ...
            <button
              ...
              disabled={apiLoading}
              className="bg-[#1a729c] backdrop-blur-sm border border-white/20 text-white px-8 py-4 rounded-xl font-medium hover:bg-[#010817]/80 transition-all duration-300 flex items-center gap-3 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
